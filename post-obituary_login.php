                ...
                <div class="login-form paddingT-10">
                    <form id="registerForm" name="myForm" method="POST">
                        ...
                        <div class="left-side">
                            ...
                            <div class="form-item"><input name="number" id="number" type="number" autocomplete="off" placeholder="Enter Mobile Number" ></div>
...
<div class="modal fade" id="forget" role="dialog">
				...
				<div id="register_form">
					<div class="login-form paddingT-10">
						<form id="registerForm" name="myForm" method="POST">
							<div class="left-side">
								<div class="form-item"><input name="mobile" type="tel" placeholder="Enter Your Phone Number" required></div>

								<div class="form-item text-center">

								<!-- <input type="submit" value="Add Packages" name="save" class="btn btn-primary"> -->

									<input type="submit" onclick="register()" value="Verify" class="button_Log" name="save">
									</div>
