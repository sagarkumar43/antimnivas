...
<!-- Mirrored from antimnivas.com/features by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Nov 2020 10:51:29 GMT -->
<!-- Added by HTTrack -->
...
-->
  ...
  <section class="section-common features">
    <div class="container">
      ...
      <div class="feature-block">
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon1.png" alt="features-icon1" /></div>
          <p>Respectful Obituaries </p>
        </div>
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon9.png" alt="features-icon1" /></div>
          <p>Condolence Messages (Multiple Language)</p>
        </div>
        <!-- <div class="box-11">
					<div class="inner-feat"><img src="/frontend/images/features-icon2.png" alt="features-icon1"/></div>
					<p>Biography (Multiple Language)</p>
				</div> -->
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon3.png" alt="features-icon1" /></div>
          <p>Photos</p>
        </div>
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon4.png" alt="features-icon1" /></div>
          <p>Videos</p>
        </div>
        <!-- <div class="box-11">
					<div class="inner-feat"><img src="frontend/images/features-icon5.png" alt="features-icon1"/></div>
					<p>Family Tree (Stay Connected)</p>
				</div> -->

        <!-- <div class="box-11">
					<div class="inner-feat"><img src="frontend/images/features-icon6.png" alt="features-icon1"/></div>
					<p>Background Music</p>
		 		</div>
				<div class="box-11">
					<div class="inner-feat"><img src="frontend/images/features-icon7.png" alt="features-icon1"/></div>
					<p>SMS Anniversary Reminders to relatives</p>
				</div>
				<div class="box-11">
					<div class="inner-feat"><img src="frontend/images/features-icon8.png" alt="features-icon1"/></div>
					<p>Email Anniversary Reminders to relatives</p>
				</div> -->

        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon10.png" alt="features-icon1" /></div>
          <p>Social Media Sharing</p>
        </div>
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon11.png" alt="features-icon1" /></div>
          <p>Advertisement Free Platform</p>
        </div>
        <div class="box-11">
          <div class="inner-feat"><img src="frontend/images/features-icon12.png" alt="features-icon1" /></div>
...
<!-- Mirrored from antimnivas.com/features by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Nov 2020 10:51:37 GMT -->
