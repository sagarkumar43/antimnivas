...
<!-- Mirrored from antimnivas.com/pricing by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Nov 2020 10:51:41 GMT -->
<!-- Added by HTTrack -->
...
-->
  ...
  <section class="section-common pricing tabel-common">
    <div class="container">
      <h2 class="heading-h2">Obituary Plans</h2>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php
                        $data="select * from add_price";
                        $exe=mysqli_query($connect,$data);
                        $read2=mysqli_fetch_array($exe);
                        ?>

          <?php echo $read2["Obituary_Plans"];?> </tbody>
  ...
  <section class="section-common pricing tabel-common">
    <div class="container">
      <h2 class="heading-h2">Home Featured Plans</h2>

      <p> </p>
      <div class="row">
        <div class="col-md-12">
          <div class="table-responsive marginB-15 marginT-15">
            <table width="100%%" border="0" cellspacing="0" cellpadding="0"
              class="table table-striped table-custom table-bordered text-center">
              <tbody>
                <?php echo $read2["Home_Featured_Plans"];?>
            </table>
          </div>
        </div>
      </div>
...
<!-- Mirrored from antimnivas.com/pricing by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Nov 2020 10:51:43 GMT -->
